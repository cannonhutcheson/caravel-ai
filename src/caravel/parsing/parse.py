...
- Needs to turn the json into a dictionary.
- Needs to parse all the paths, mapping the first sentence of the description to the path. 
- A utility function that turns the descriptions into one liners via LLM call?
- A function to get route by description.
- A function to get params by route.
'''
